...
public class ApiSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        com.example.authenservice.config.ApiAuthenticationFilter apiAuthenticationFilter = new com.example.authenservice.config.ApiAuthenticationFilter(authenticationManagerBean());
        ...
        http.addFilterBefore(new com.example.authenservice.config.ApiAuthorizationFilter(), UsernamePasswordAuthenticationFilter.class);
    }
